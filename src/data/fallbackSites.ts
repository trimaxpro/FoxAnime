...
export const FALLBACK_SITES: AnimeSite[] = [
  ...
  },
  {
    ...
    "description": "Comprehensive otaku directory listing reliable anime, manga, and light novel resources.\nFeatures active domain monitoring, privacy tips, and community-vetted mirrors.",
    "category": "index",
    "tags": [
      "Index",
      "Wiki",
  ...
  },
  {
    ...
    "description": "Well-structured open-source database organizing anime streaming portals and trackers.\nConstantly audited for uptime, ad intrusion levels, and video playback quality.",
    "category": "index",
    "tags": [
      "Index",
      "Library",
  ...
  },
  {
    ...
    "description": "Extensive knowledge base documenting media servers, streaming portals, and scraper tools.\nIncludes optimization tips, subtitle guides, and alternative streaming endpoints.",
    "category": "index",
    "tags": [
      "Wiki",
      "Guides",
  ...
  },
  {
    ...
    "description": "The gold-standard community index comparing dozens of anime streaming services.\nRanks sites by ad density, video resolution, dub availability, and server speed.",
    "category": "index",
    "tags": [
      "Index",
      "Rankings",
  ...
  },
  {
    ...
    "description": "High-speed official backup mirror for the EverythingMoe community directory.\nProvides uninterrupted access when the primary domain encounters DNS blocks.",
    "category": "mirrors",
    "tags": [
      "Mirror",
      "Backup",
  ...
  },
  {
    ...
    "description": "Ultra-fast modern anime player supporting soft & hard subtitles with English dubs.\nIncludes automated next episode playback, custom themes, and progress sync.",
    "category": "streaming",
    "tags": [
      "Sub / Dub",
      "Auto-Next",
  ...
  },
  {
    ...
    "url": "https://miruro.tv/",
    "description": "Official television-optimized mirror delivering seamless Miruro streaming playback.\nFast CDN failover ensuring low latency streaming during high traffic hours.",
    "category": "mirrors",
    "tags": [
      "Mirror",
      "TV Optimized",
  ...
  },
  {
    ...
    "url": "https://miruro.bz/",
    "description": "Alternate European proxy mirror for continuous Miruro anime streaming access.\nMaintains full playlist sync, watchlist bookmarks, and subtitle options.",
    "category": "mirrors",
    "tags": [
      "Mirror",
      "EU Proxy",
  ...
  },
  {
    ...
    "url": "https://miruro.ru/",
    "description": "Regional mirror providing high-bitrate video streams for Miruro users worldwide.\nFull support for 1080p resolution, keyboard shortcuts, and episode autoplay.",
    "category": "mirrors",
    "tags": [
      "Mirror",
      "1080p",
  ...
  },
  {
    ...
    "url": "https://miruro.to/",
    "description": "Global top-level domain mirror for Miruro featuring identical real-time libraries.\nOffers dual audio options with instant search auto-completion.",
    "category": "mirrors",
    "tags": [
      "Mirror",
      "Sub / Dub",
  ...
  },
  {
    ...
    "description": "Live network telemetry and uptime dashboard for all official Miruro domains.\nCheck real-time server health, latency, maintenance alerts, and domain changes.",
    "category": "tools",
    "tags": [
      "Status",
      "Monitoring",
  ...
  },
  {
    ...
    "description": "Legendary anime streaming platform known for lightweight, low-data 1080p encodes.\nRapid simulcast uploads with dual-audio support and clean, minimalistic design.",
    "category": "streaming",
    "tags": [
      "Sub / Dub",
      "Low Data",
